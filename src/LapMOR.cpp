...
int main (int argc , char **argv ){ 
    ...
    fclose(fp1); 
    fclose(fp2); 
    model_LapMOR(train_input , train_output, B , A , lambda1 , lambda2) ;   
    cout <<predict_LapMOR(test_input , test_output , B , A , lambda1 , lambda2, true) <<endl ;  
